...
// MQTT
const char* mqtt_server = "192.168.43.42";  // IP of the MQTT broker
const char* humidity_topic = "esp32/hum";
const char* temperature_topic = "esp32/temp";
const char* mqtt_username = "pi"; // MQTT username
const char* mqtt_password = "1234"; // MQTT password
const char* clientID = "pi"; // MQTT client ID
